          ...
          >
            ...
            <div className="px-3 py-2 border-t border-slate-200 dark:border-slate-700 flex gap-2 overflow-x-auto scrollbar-hide">
              ...
              <button 
                ...
                className="whitespace-nowrap px-2 py-1 bg-amber-100 dark:bg-amber-900/30 text-amber-700 dark:text-amber-300 rounded-full text-xs hover:bg-amber-200 dark:hover:bg-amber-800/30"
              >
                About Prime
              </button>
              <button 

    ...
    <div className="min-h-[60vh] py-8">
      ...
      >
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <fieldset className="space-y-4 p-4 border rounded-lg">
            ...
            <div>
              <div className="flex items-center justify-between">
                ...
                <span className="text-xs text-slate-500">{videoPreviews.length}/5 videos</span>
              </div>
              ...
              <div className="mt-2 flex items-center flex-wrap gap-4">
                ...
                {videoPreviews.length < 5 && (
                  <label htmlFor="video-upload" className="cursor-pointer w-32 h-24 border-2 border-dashed rounded-lg flex flex-col items-center justify-center text-slate-400 hover:border-indigo-500">
                    <UploadIcon />
                    <span className="text-xs">Add Video</span>
                    <span className="text-[10px] text-slate-500">Max 1 min each</span>
                    <input 
                      id="video-upload" 
                      name="video-upload" 
                      type="file" 
            ...
            <div>
              ...
              <input 
                ...
                className={`mt-1 ${INPUT_STYLE}`}
              />
              <p className="text-xs text-slate-500 mt-1">You can provide a YouTube or other video URL in addition to or instead of uploading videos</p>
            </div>
          </fieldset>
          ...
          <button type="submit" className="w-full py-3 px-4 bg-indigo-600 hover:bg-indigo-700 text-white font-semibold rounded-lg transition">
            List My Item
          </button>
        </form>
      </motion.div>
